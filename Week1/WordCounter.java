...
class WordCounter {
  public static void main(String[] args) {
    ...
    HashMap<String, Integer> frequencies = countWordsInFile("../pride-and-prejudice.txt",stop_words);

    ArrayList<Map.Entry<String, Integer>> freq_list = sortFrequencies(frequencies);
  ...
  private static HashMap<String, Integer> countWordsInFile(String filepath, ArrayList<String> stop_words) {
  ...
  private static ArrayList<Map.Entry<String,Integer>> sortFrequencies(HashMap<String,Integer> frequencies){
